...
class SensorMConstraint(): ExtendableMConstraint(), Tickable, MCAutoSerializable {
    ...
    override fun iCopyMConstraint(level: ServerLevel, mapped: Map<ShipId, ShipId>): MConstraint? {
        ...
        return SensorMConstraint(nShip.id, nPos, nBPos, lookDir, maxDistance, ignoreSelf, scale, channel)
    }
