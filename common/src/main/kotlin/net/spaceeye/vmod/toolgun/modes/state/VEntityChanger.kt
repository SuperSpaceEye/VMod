...
class VEntityChanger: ExtendableToolgunMode(), VEntityChangerHUD, VEntityChangerGUI {
    ...
    companion object {
        ...
        val c2sSendUpdate = regC2S<C2SSendUpdate>("send_update", "ventity_changer",
            { pkt, player -> ServerToolGunState.playerHasPermission(it, VEntityChanger::class.java as Class<BaseMode>) },
            { pkt, player -> ServerToolGunState.s2cErrorHappened.sendToClient(it, ServerToolGunState.S2CErrorHappened(
